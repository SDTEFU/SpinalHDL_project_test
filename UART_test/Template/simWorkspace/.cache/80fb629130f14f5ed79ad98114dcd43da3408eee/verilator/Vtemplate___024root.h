...
class Vtemplate___024root final : public VerilatedModule {
  public:
    ...
    VL_IN8(clk,0,0);
    VL_IN8(reset,0,0);
    CData/*7:0*/ template__DOT__clkarea_data_bat_data_bat;
    CData/*0:0*/ template__DOT__clkarea_state_state;
    CData/*0:0*/ template__DOT__when_template_l46;
    CData/*0:0*/ template__DOT__clkarea_bit_flag_bit_flag;
    CData/*3:0*/ template__DOT__clkarea_bit_cnt_bit_cnt;
    CData/*0:0*/ template__DOT__when_template_l70;
    CData/*0:0*/ template__DOT__clkarea_rx232_tx_rx232_tx;
    CData/*0:0*/ template__DOT__clkarea_done_done;
    CData/*0:0*/ __Vtrigrprev__TOP__io_clk;
    CData/*0:0*/ __Vtrigrprev__TOP__io_rst_n;
    CData/*0:0*/ __VactDidInit;
    CData/*0:0*/ __VactContinue;
    SData/*9:0*/ template__DOT__clkarea_baud_cnt_baud_cnt;
