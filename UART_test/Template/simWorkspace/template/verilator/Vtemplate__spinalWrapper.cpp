...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.io_clk );
      signalAccess[1] = new CDataSignalAccess( top.io_rst_n );
      signalAccess[2] = new CDataSignalAccess( top.io_start );
      signalAccess[3] = new CDataSignalAccess( top.io_data );
      signalAccess[4] = new CDataSignalAccess( top.io_rs232_tx );
      signalAccess[5] = new CDataSignalAccess( top.io_done );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/adgert/Desktop/test/MCU_project/UART_test/Template (copy)/./simWorkspace/template/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/adgert/Desktop/test/MCU_project/UART_test/Template (copy)/./simWorkspace/template/") + name + ".dat").c_str());
      #endif
    }
